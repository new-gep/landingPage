  ...
  return (
    <>
      ...
      >
        ...
        <h2 className="mx-auto mb-4 text-3xl font-bold text-black dark:text-primary md:w-4/5 xl:w-1/2 xl:text-sectiontitle3">
          {subtitle}
        </h2>
        <p className="mx-auto md:w-4/5 lg:w-3/5 xl:w-[46%] text-justify">{description}</p>
      </motion.div>
      {/* <!-- Section Title End --> */}
    </>
  );
